...
var _ protoreflect.List = (*_Event_3_list)(nil)

type _Event_3_list struct {
	list *[]string
}

func (x *_Event_3_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Event_3_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_Event_3_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_Event_3_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_Event_3_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Event at list field Organizers as it is not of Message kind"))
}

func (x *_Event_3_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_Event_3_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_Event_3_list) IsValid() bool {
	return x.list != nil
}
...
func (x *fastReflection_Event) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Organizers) != 0 {
		value := protoreflect.ValueOfList(&_Event_3_list{list: &x.Organizers})
...
func (x *fastReflection_Event) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ems.v1.Event.organizers":
		if len(x.Organizers) == 0 {
			return protoreflect.ValueOfList(&_Event_3_list{})
		}
...
func (x *fastReflection_Event) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ems.v1.Event.organizers":
		...
		value := &_Event_3_list{list: &x.Organizers}
